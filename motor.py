...
class MOTOR:
    ...
    def Prepare_To_Act(self):
        ...
        value = self.frequency * numpy.linspace(0,2 * c.pi, c.runTime) + self.offset
        self.motorValues = self.amplitude * numpy.sin(value)

    def Set_Value(self, t, robot):
        pyrosim.Set_Motor_For_Joint(bodyIndex = robot.robotId, jointName = self.jointName, controlMode = p.POSITION_CONTROL, targetPosition = self.motorValues[t], maxForce = 100)
